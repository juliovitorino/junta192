...
class CartaoCarimbos20 extends StatefulWidget {
  dynamic _cartaofull;
  bool timestampshow;

  CartaoCarimbos20(this._cartaofull, {this.timestampshow=false});

  @override
  _CartaoCarimbos20State createState() => _CartaoCarimbos20State();
}

class _CartaoCarimbos20State extends State<CartaoCarimbos20> {
